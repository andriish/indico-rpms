...
copr-cli create --chroot fedora-38-x86_64 --chroot fedora-38-x86_64 I323
...
#!/bin/bash
git clone --depth 3 https://github.com/andriish/indico-rpms.git -b indico323
cd indico-rpms
sh srpmsbuild.sh  $name $version
EOF
copr add-package-custom I323 \
        --name $name \
        --script temp.sh \
