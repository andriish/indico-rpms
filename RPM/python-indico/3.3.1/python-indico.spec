...
Source1:        https://github.com/indico/indico-plugins/archive/refs/tags/v3.3.tar.gz
BuildArch:      noarch
...
%autosetup  -n indico-3.3.1 -p 1
#setup -q -T -D -a 1 -n indico-{igittag}
%setup -q -T -D -a 1 -n indico-3.3.1
mkdir -p plugins
#mv indico-plugins-{pgittag} plugins/base
mv indico-plugins-3.3 plugins/base
